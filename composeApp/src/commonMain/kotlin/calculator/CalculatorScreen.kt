...
fun CalculatorScreen(
    ...
    Box(modifier = Modifier.fillMaxSize(),
        ...
        Column(
            ...
            BMIBackdropView(modifier = Modifier.fillMaxWidth().weight(0.5f), color = state.accentColor)
            BodyMeasurementsView(
                modifier = Modifier.fillMaxWidth().weight(0.5f),
                heightCm = state.bodyMeasurement.heightFt,
                heightDisplay = state.heightDisplay,
                weightKg = state.bodyMeasurement.weightKg,
